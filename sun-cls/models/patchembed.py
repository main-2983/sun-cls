...
class PatchEmbed3D(BaseModule):
    ...
    Args:
        ...
        stride (int): stride of PE, default is 16 in vanilla ViT
        padding (int): padding of PE, default is 0
        in_channels (int): input channels, usually 3
        out_channels (int): output embedding dim, default to 768
        norm_cfg (dict): a config to build normalization module, default to None
    """
    def __init__(self,
                 patch_size=16,
                 stride=16,
